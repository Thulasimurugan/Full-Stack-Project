                    ...
                    <div className='px-3 mt-4 d-flex'>
                        <div className="w-100">
                            <ul className="list-unstyled m-0">
                                {menuDropDown.filter((values) => values.navUrl !== location.pathname).map((values, index) => (
                                    <li className="mb-1" key={index}>
                                        <Link to={values.navUrl} onClick={() => {handleMenuOpen();handleChangeActiveDropDown();}} className="text-decoration-none d-flex flex-row gap-2 mb-3 align-items-center" style={{ color: isTheme === "Dark" ? 'white' : '#003569' }}>
                    ...
                    <div className='w-100 d-flex align-items-center justify-content-between'>
                        ...
                        <nav className="m-0 p-0 d-xl-flex d-none">
                            <div className="m-0 p-0 mx-auto">
                                <ul className='nav gap-3 p-0 m-0'>
                                    {navBar.filter((values) => values?.navUrl !== location.pathname).map((navigation, index) => (
                                                ...
                                                {activeDropDown === navigation.navName && (
                                                    ...
                                                    >
                                                        <div className="w-100">
                                                            ...
                                                            <ul className="list-unstyled m-0">
                                                                {menuDropDown.map((values, index) => (
                                                                    <li className="mb-1" key={index}>

                                                                        <Link to={values.navUrl} onClick={() => handleChangeActiveDropDown()} className="text-decoration-none d-flex flex-row gap-2" style={{ color: '#003569' }}>
                        ...
                        <div className='m-0 p-0 d-flex flex-row'>
                            <nav className='flex-rows gap-3 d-flex m-0 p-0 d-sm-flex d-none'>
                                {navBarSideIcons.filter((values) => values.navUrl !== location.pathname).map((navigation, index) => (
                                    <Link
