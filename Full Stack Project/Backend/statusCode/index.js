...
const statusCode = {
    ...
    NOT_SUPER_ADMIN:414,
    NO_USER_FOUND:415,
    USER_MAIL_NOT_SENDED:416,
    CHANGING_SUPER_ADMIN_ROLE:417,
...
const statusMessage = {
    ...
    414:'You are a not super admin, You do not have access',
    415:'No users found with the specified role',
    416:'Unable to send email to user. Check your internet connection and try again',
    417:'Super admins cannot modify roles of other super admins',
    422:'is required',
